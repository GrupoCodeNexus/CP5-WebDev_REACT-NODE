    ...
    <div className='mb-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
      <div className='bg-blue-100 rounded-md shadow-md relative overflow-hidden'>
        <div className='relative'>
          <img src='https://img.odcdn.com.br/wp-content/uploads/2024/01/segway-e-bike.webp' alt='noticia-1' className='w-full h-auto aspect-video object-cover bg-blue-300'/>
