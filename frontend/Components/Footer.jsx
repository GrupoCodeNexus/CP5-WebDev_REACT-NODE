    ...
    <footer className="bg-blue-900 text-gray-200 py-8">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="redes-sociais">
                ...
                <ul className="flex text-yellow-500 space-x-4 flex-wrap sm:flex-col sm:space-x-2">
            ...
            <button className='cursor-pointer rounded-lg bg-yellow-500 pl-4 pr-4 p-2 transition delay-50 duration-300 ease-in-out hover:scale-110'>Falar com o especialista</button>
            </div>
        </div>
    </footer>
    </>
